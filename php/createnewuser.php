...
<!-- 
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center">Code Issue Tracker </h3>
              ...
              <div class="col-sm-5 authfy-panel-left">
                <div class="brand-col">
                  <div class="headline">
                    ...
                    <!-- ./brand-logo -->
                    <p>CODE ISSUE TRACKER  SYSTEM</p>
                    <!-- <p>CREATE YOUR ACCOUNT</p> -->
                    <!-- social login buttons start -->
                    <div class="row social-buttons">
                      <div class="col-xs-4 col-sm-4 col-md-12">
                        <a href="#" class="btn btn-block btn-facebook">
                          <i class="fa fa-facebook"></i> <span class="hidden-xs hidden-sm">“ A problem is a chance for you to do your best.”</span>
                        </a>
                      </div>
                      <div class="col-xs-4 col-sm-4 col-md-12">
                        <a href="#" class="btn btn-block btn-twitter">
                          <i class="fa fa-twitter"></i> <span class="hidden-xs hidden-sm">“If your only tool is a hammer then every problem looks like a nail.”</span>
                        </a>
                      </div>
                      <div class="col-xs-4 col-sm-4 col-md-12">
                        <a href="#" class="btn btn-block btn-google">
                          <i class="fa fa-google-plus"></i> <span class="hidden-xs hidden-sm">“A problem well stated is a problem half solved.”</span>
                        </a>
                      </div>
                    </div><!-- ./social-buttons -->
                  </div>
                ...
                <div class="authfy-login">
                  ...
                  <div class="authfy-panel panel-login text-center active">
                    <div class="authfy-heading">
                      <h6 class="auth-title">Create your account</h6>
                      <p>Don’t have an account? <a class="lnk-toggler" data-panel=".panel-signup" href="#">Register Here</a></p>
                    </div>
                    <div class="row">
                      <div class="col-xs-12 col-sm-12">
                        <!-- <form name="loginForm" class="loginForm" action="#" method="POST"> -->
                        <form  name="reg_Form" class="reg_Form" action="#" method="POST" id="reg-form" >
                    <!-- <center><small>Please enter your credentials.</small></center> -->
                          <div class="form-group">
                          <!-- <label for="username" class="control-label">Username</label> -->
                        <input type="text" id="username" autofocus name="username" placeholder="Enter your username" class="form-control form-control-sm rounded-0" required>  
                        ...
                        <input type="tel" maxlength="10" id="PhoneNumber" autofocus name="PhoneNumber" placeholder="Enter your PhoneNumber" class="form-control form-control-sm rounded-0" required>  
                          <!-- <input type="email" class="form-control email" name="username" placeholder="Email address"> -->
                          </div>
                        ...
                        <input type="email" id="email" autofocus name="email" placeholder="Enter your email" class="form-control form-control-sm rounded-0" required>  
                          <!-- <input type="email" class="form-control email" name="username" placeholder="Email address"> -->
                          </div>
                          ...
                          <div class="form-group">
                            <div class="pwdMask">
                            <!-- <label for="password" class="control-label">Password</label> -->
                        <input type="password" id="password" name="password" placeholder="Enter your password" class="form-control form-control-sm rounded-0" required> 
                        ...
                        <input type="password" id="confirmpassword" name="confirmpassword" placeholder=" confirmpassword" class="form-control form-control-sm rounded-0" required> 
                            <!-- <input type="password" class="form-control password" name="password" placeholder="Password"> -->
                              <span class="fa fa-eye-slash pwd-toggle"></span>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <a href="./login.php" class="btn btn-sm btn-primary rounded-0 my-1" type="button">Login Here</a>
                          </div>
                        </form>
                      </div>
                    </div>
...
<script>
    $(function(){
        $('#reg-form').submit(function(e){
            ...
            $.ajax({
                url:'Actions.php?a=register_user',
                method:'POST',
                data:$(this).serialize(),
                dataType:'JSON',
                error:err=>{
